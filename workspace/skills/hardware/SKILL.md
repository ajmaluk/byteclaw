---
name: hardware
description: Read and control I2C and SPI peripherals on ajmaluk boards (LicheeRV Nano, MaixCAM, NanoKVM).
homepage: https://wiki.ajmaluk.com/hardware/en/lichee/RV_Nano/1_intro.html
...
Most I2C/SPI pins are shared with WiFi on ajmaluk boards. You must configure pinmux before use.
