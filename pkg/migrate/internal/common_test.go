...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.byteclaw")
	assert.Equal(t, "/home/user/.byteclaw/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.byteclaw/workspace/file.txt", "/home/user/.byteclaw")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".byteclaw"), result)
}
