...
func TestDefaultConfig_WorkspacePath_Default(t *testing.T) {
	...
	t.Setenv("BYTECLAW_HOME", "")
	// Set a known home for consistent test results
	t.Setenv("HOME", "/tmp/home")

	cfg := DefaultConfig()
	want := filepath.Join("/tmp/home", ".byteclaw", "workspace")
...
func TestDefaultConfig_WorkspacePath_WithByteclawHome(t *testing.T) {
	t.Setenv("BYTECLAW_HOME", "/custom/byteclaw/home")

	cfg := DefaultConfig()
	want := "/custom/byteclaw/home/workspace"

	if cfg.Agents.Defaults.Workspace != want {
		t.Errorf("Workspace path with BYTECLAW_HOME = %q, want %q", cfg.Agents.Defaults.Workspace, want)
	}
}
